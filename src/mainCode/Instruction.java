...
public class Instruction {
	...
	private int type = 0;// Flag for current instruction interpretation (0 is poll, 1 is receive button
							// input, 2 is movement to a floor)
	...
	/*
	 * public int getfloorOrder() { return floorOrder; }
	 * 
	 * public void setfloorOrder(int floorOrder) { this.floorOrder = floorOrder; }
	 */
	public int getMove() {
		return move;
	}
